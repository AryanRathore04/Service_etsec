  ...
  return (
    <div className="cyber-container">
      ...
      >
        ...
        >
          Ready to get started with satellite security?
        </h2>
        <button
            ...
            >
              ...
              <div className="service-content">
                <div className="service-icon-wrapper">
                  <div className="service-icon">{currentServiceGroup.icon}</div>{" "}
                  {/* Use group icon or define service icons */}
...
export default SatelliteSecurity;
