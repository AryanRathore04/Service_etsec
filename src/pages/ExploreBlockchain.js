  ...
  return (
    <div className="cyber-container">
      ...
      <header className={`header ${isVisible ? "fade-in" : ""}`}>
        <div className="header-content">
          ...
          <p className="subtitle">
            All blockchain services like smart contract auditing
          </p>
        </div>
      </header>

      {/* Get Started Button - moved above services grid */}
      <div style={{ textAlign: "center", margin: "3rem 0 2rem 0" }}>
        ...
        >
          Ready to get started with blockchain security?
        </h2>
        <button
